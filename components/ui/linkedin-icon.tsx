...
// Lucide dropped its brand marks, so the LinkedIn logo ships here as a plain path,
// alongside `github-icon.tsx`. Sized and coloured through `currentColor` like every
// lucide icon beside it.
